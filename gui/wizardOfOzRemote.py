...
class WizardOfOzRemote(object):
    ...
    def addEmorecTab(self):
        ...
        self.add_button(self.emorecTab, row=1, column=col, text="Show me in your face happiness", event="athena.games.sums.playemotionwav", event_text='r1-happy')
        self.add_button(self.emorecTab, row=2, column=col, text="Show me in your face sadness", event="athena.games.sums.playemotionwav", event_text='r1-sad')
        self.add_button(self.emorecTab, row=3, column=col, text="Show me in your face fear", event="athena.games.sums.playemotionwav", event_text='r1-fear')
        self.add_button(self.emorecTab, row=4, column=col, text="Show me in your face happiness plain", event="athena.games.sums.playemotionwav", event_text='r1-happy-2')
        self.add_button(self.emorecTab, row=5, column=col, text="Show me in your face sadness plain", event="athena.games.sums.playemotionwav", event_text='r1-sad-2')
        self.add_button(self.emorecTab, row=6, column=col, text="Show me in your face fear plain", event="athena.games.sums.playemotionwav", event_text='r1-fear-2')

        self.add_button(self.emorecTab, row=8, column=col, text="Show me in your face - picture", event="athena.games.sums.playemotionwav", event_text='r2')

        col += 1
        Label(self.emorecTab, text="Bravo").grid(row=0, column=col)
        self.add_button(self.emorecTab, row=1, column=col, text="Bravo male", event="athena.games.sums.playemotionwav", event_text='bravoeisaikalos')
        self.add_button(self.emorecTab, row=2, column=col, text="Bravo female", event="athena.games.sums.playemotionwav", event_text='bravoeisaikali')
        self.add_button(self.emorecTab, row=3, column=col, text="Bravo - plain", event="athena.games.sums.playemotionwav", event_text='bravo')
        self.add_button(self.emorecTab, row=4, column=col, text="Bravo less expressive", event="athena.games.sums.playemotionwav", event_text='bravo-less-expressive')

        col += 1
        Label(self.emorecTab, text="Look at me").grid(row=0, column=col)
        self.add_button(self.emorecTab, row=1, column=col, text="Look at me do the same - happy", event="athena.games.sums.playemotionwav", event_text='r3-happy')
        self.add_button(self.emorecTab, row=2, column=col, text="Look at me do the same - sad", event="athena.games.sums.playemotionwav", event_text='r3-sad')
        self.add_button(self.emorecTab, row=3, column=col, text="Look at me do the same - fear", event="athena.games.sums.playemotionwav", event_text='r3-fear')
        self.add_button(self.emorecTab, row=4, column=col, text="Look at me - happy", event="athena.games.sums.playemotionwav", event_text='r4-happy')
        self.add_button(self.emorecTab, row=5, column=col, text="Look at me - sad", event="athena.games.sums.playemotionwav", event_text='r4-sad')
        self.add_button(self.emorecTab, row=6, column=col, text="Look at me - fear", event="athena.games.sums.playemotionwav", event_text='r4-fear')
